...
import Footer from "@components/footer";import dynamic from "next/dynamic";

const CoordinatesMap = dynamic(() => import("@components/CoordinatesMap"), { ssr: false });


export default function Home() {
  return (
    <div className="bg-modelo-blue font-sans leading-normal tracking-normal h-screen">
      <Navbar />
      {/* <!--Container--> */}
              ...
              <div className="p-3">
                ...
                <div className="bg-modelo-yellow border border-modelo-red rounded shadow h-full">
                  <div className="border-b border-modelo-red p-3">
                    <h5 className="font-bold uppercase text-modelo-blue">Graph</h5>
                  </div>
                </div>
                {/* <!--/Graph Card--> */}
              </div>
